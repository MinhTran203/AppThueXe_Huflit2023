...
TaiKhoan taiKhoan;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnDangKy.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(DangNhapNV.this,DangKy.class);
                    ...
                    for (int i = 0 ; i < response.length();i++) {
                        ...
                        if (edttk.getText().length() != 0 && edtmk.getText().length() != 0) {
                            if (edttk.getText().toString().equals(Tentaikhoan) && edtmk.getText().toString().equals(matkhau)) {
                                ...
                                Intent intent = new Intent(DangNhapNV.this, LoaiXe_Activity.class);
                                startActivity(intent);

                            } else if(edttk.getText().toString().equals(tkquanly)&& edtmk.getText().toString().equals(passquanly)){
                                ...
                                Toast.makeText(DangNhapNV.this, "Đăng nhập thất bại", Toast.LENGTH_SHORT).show();
                            }
                        }else{
